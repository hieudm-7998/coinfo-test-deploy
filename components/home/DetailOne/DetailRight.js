  ...
  return (
    <>
      <div className="col-xxl-5 col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 mobt-50">
        <div
          className="hrdd-section-title wow animate fadeInDown"
        ...
        <div
          className="hrrd-everything-btn-wrap wow animate fadeInUp"
          data-wow-delay="450ms"
          data-wow-duration="1500ms"
        >
          <button className="detail-action-btn">
            <Link href="/">
              <a>{HomeDetailOne.ActionBtn}</a>
            </Link>
          </button>
        </div>
      </div>
